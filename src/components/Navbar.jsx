...
function Navbar() {
  ...
  return (
    <>
      <nav className="w-full h-20  bg-gray-white/20 backdrop-blur-md shadow-2xl flex justify-between  items-center sticky md:pt-5 md:pb-5  mx-auto px-2">
        {/* left side */}
        <div className="flex space-x-1 ml-5 text-2xl font-extrabold items-center md:text-4xl md:font-extrabold text-gray-900">
          <Link to="/">
            <span>
              <House className="text-orange-400 curstor-pointer hover:text-orange-500 transition-all duration-200" />
            </span>
          </Link>
          <h1 className="lg:text-4xl lg:font-extrabold">
        ...
        {/* right side */}
        <Link to="/Cartpage">
          <div className="mr-4  p-1 rounded-md  border-1 relative">
